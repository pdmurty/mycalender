...
public class TimePrefV7DlgFragmentCompat extends PreferenceDialogFragmentCompat {
    ...
    public static TimePrefV7DlgFragmentCompat newInstance(
            String key) {
        final TimePrefV7DlgFragmentCompat
                fragment = new TimePrefV7DlgFragmentCompat();
