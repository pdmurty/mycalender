...
// Hide the status bar.
        ...
        View tv = findViewById(R.id.pref_container);
        ViewCompat.setOnApplyWindowInsetsListener(
                tv, (v, windowInsets) -> {
                    ...
                    Log.d("INS", insets.toString());
                    Log.d("INSmlp", String.valueOf(mlp.leftMargin)+","
                            +String.valueOf(mlp.topMargin) +","
                            +String.valueOf(mlp.rightMargin)+","
                            +String.valueOf(mlp.bottomMargin));
